...
class RcpspAssignment final :
 ...
 public:
  ...
  explicit constexpr RcpspAssignment(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline void RcpspProblem::set_allocated_basedata(std::string* basedata) {
  ...
  if (basedata_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
...
inline void RcpspAssignment::set_start_of_task(int index, int64_t value) {
  start_of_task_.Set(index, value);
...
inline int RcpspAssignment::_internal_selected_recipe_of_task_size() const {
  return selected_recipe_of_task_.size();
}
...
inline void RcpspAssignment::set_selected_recipe_of_task(int index, int32_t value) {
  selected_recipe_of_task_.Set(index, value);
...
inline void RcpspAssignment::_internal_add_selected_recipe_of_task(int32_t value) {
  selected_recipe_of_task_.Add(value);
}
...
RcpspAssignment::_internal_selected_recipe_of_task() const {
  return selected_recipe_of_task_;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
