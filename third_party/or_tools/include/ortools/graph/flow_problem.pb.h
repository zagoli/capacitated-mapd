...
class FlowArcProto final :
 ...
 public:
  ...
  explicit constexpr FlowArcProto(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class FlowNodeProto final :
 ...
 public:
  ...
  explicit constexpr FlowNodeProto(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class FlowModelProto final :
 ...
 public:
  ...
  explicit constexpr FlowModelProto(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline ::operations_research::FlowModelProto_ProblemType FlowModelProto::_internal_problem_type() const {
  return static_cast< ::operations_research::FlowModelProto_ProblemType >(problem_type_);
}
